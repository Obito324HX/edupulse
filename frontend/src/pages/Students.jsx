              ...
              <tr key={student.id} style={{ borderTop: '1px solid var(--border)', background: i % 2 === 0 ? 'var(--dark)' : 'var(--dark-secondary)' }}>
                ...
                <td className='px-6 py-4'>
                  <span className='px-3 py-1 rounded-full text-xs font-medium'
                    style={{ background: student.is_active ? 'color-mix(in srgb, var(--success) 16%, transparent)' : 'color-mix(in srgb, var(--danger) 16%, transparent)', color: student.is_active ? 'var(--success)' : 'var(--danger)' }}>
